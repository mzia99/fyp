  ...
  <header id="header" class="fixed-top">
	...
	<?php
		if(isset($_SESSION['user_role'])){
			...
			if($role==0){
				?>
					<a  href="doctors/all-appointments.php" class="appointment-btn scrollto"><span class="d-none d-md-inline">All Appointments</span> </a>
					<a style="background-color:chocolate;" href="doctors/availability.php" class="appointment-btn scrollto"><span class="d-none d-md-inline">Date/Slots</span> </a>
			...
			if($role==1){
				...
				<a href="appointment.php" class="appointment-btn scrollto"><span class="d-none d-md-inline">Make an</span> Appointment</a>
					<a style="background-color:chocolate;" href="all-appointments.php" class="appointment-btn scrollto"><span class="d-none d-md-inline">All Appointments</span> </a>
				<?php
			}
			?>
