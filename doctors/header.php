		...
		if(isset($_SESSION['user_role'])){
			...
			if($role==0){
				?>
					...
					<a  href="all-appointments.php" class="appointment-btn scrollto"><span class="d-none d-md-inline">All Appointments</span> </a>
					<a style="background-color:chocolate;" href="availability.php" class="appointment-btn scrollto"><span class="d-none d-md-inline">Date/Slots</span> </a>
			...
			<a href="appointment.php" class="appointment-btn scrollto"><span class="d-none d-md-inline">Make an</span> Appointment</a>
					...
					<a  href="../admin/dashboard.php" class="appointment-btn scrollto"><span class="d-none d-md-inline">All Appointments</span> </a>
